...
def calc_freq_of_occurrence_reflectivity(radar_ze, bin_width=1):
...
def plot_frequency_of_occurence_LIMRAD94(program, plot_path, larda_system):
    ...
    for p in program:
        ...
        foc_array, hist_bins = calc_freq_of_occurrence_reflectivity(radar_ze)
        ...
        figname = f"{plot_path}/RV-Meteor_{system}_freq_of_occurrence_{p}_{begin_dt:%Y%m%d}-{end_dt:%Y%m%d}.png"
