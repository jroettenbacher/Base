...
Replace `jr`with `ca` to get quicklooks from Claudia's approach. You can copy the hourly quicklooks in the same folder to jump between them. This helps to see the differences better.

## 1.2 Theoretical thoughts about the correction
