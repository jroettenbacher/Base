...
echo "##################################################"
/home/jroettenbacher/envs/jr_base/bin/python3 /projekt1/remsens/work/jroettenbacher/Base/create_limrad94_calibrated.py date=20200128 path='/projekt2/remsens/data_new/site-campaign/rv_meteor-eurec4a/instruments/LIMRAD94/cloudnet_input_heave_cor_dealiased' > /projekt1/remsens/work/jroettenbacher/Base/log/create_limrad94_calibrated_200128.log 2>&1
