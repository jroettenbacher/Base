...
plot_path = f'/projekt2/remsens/data_new/site-campaign/rv_meteor-eurec4a/instruments/LIMRAD94/cloudnet_input_heave_cor_{version}/fft_check'
range_ = [0, 'max']
...
mdv_cor = larda.read(f"LIMRAD94_cni_hc_{version}", "Vel", TIME_SPAN_, range_)
mdv_cor['var'][mdv_cor['mask']] = np.nan
mdv_cor_roll = larda.read(f"LIMRAD94_cni_hc_{version}", "Vel_roll", TIME_SPAN_, range_)
...
jr.plot_fft_spectra(mdv['var'], chirp_ts, mdv_cor['var'], chirp_ts_shifted, mdv_cor_roll['var'], 3, rg_borders_id, 400,
                    seapath, pathFig=plot_path)
