...
time = dt.datetime(2020, 2, 10, 22, 15, 0)
plot_range = [2000]
...
# testing
heave_cor_array_2[158, 76]
heave_cor_array_2[187, 76]
n_dopp_bins_shift[158, 76]  # 10.02.2020 22:15:00, 2000m
n_dopp_bins_shift[187, 76]  # 10.02.2020 22:16:00, 2000m
data['VHSpec']['mask'][158, 0, 76]
data['VHSpec']['var'][158, 0, 76] - data['VHSpec_shift']['var'][158, 0, 70]
np.diff(data['VHSpec']['vel'])
